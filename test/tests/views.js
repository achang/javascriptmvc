	  ...
	  new Test.Unit.Runner({
	    ...
	    test_link_to: function() { with(this) {
			...
			assertEqual( "<a onclick='get({\"controller\": \"con\", \"action\": \"act\"});return false;' href='#' >hello world</a>", 
				EjsView.link_to('hello world', {controller: 'con', action: 'act'}  )  )
	    }},
		...
		test_form_tag: function() { with(this) {
			...
			assertEqual("<form onsubmit='return EjsView.post_form(this, {\"controller\": \"con\", \"action\": \"act\"});' >", EjsView.form_tag( {controller: 'con', action: 'act' } ) )
	    }},
		...
		test_current_page : function(){with (this){
			...
			assert( EjsView.is_current_page( {controller: 'test', action: 'start'} ) );
