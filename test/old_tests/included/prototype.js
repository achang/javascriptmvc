 ...
 *  For details, see the Prototype web site: http://www.prototypMVC.View.org/
 *
 *--------------------------------------------------------------------------*/
...
var Class = {
  create: function(parent, methods) {
    ...
    // added by Jupiter IT for class attribute inheritance
    if (Object.isFunction(parent)) {
	  Object.extend(method, Object.clone(parent));
	}
...
Element.Methods = {
  ...
  getStyle: function(element, style) {
    ...
    if (!value) {
      var css = document.defaultMVC.View.getComputedStyle(element, null);
