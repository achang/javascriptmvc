  ...
  buildAttributes: function(model, async, callback)
  {
    ...
    var buildWork = bind(model, function(doc) {
	  ...
	  for(var col_name in this.columns_hash) {
	  	if(this.columns_hash.hasOwnProperty(col_name)) {
...
Object.extend(Jester.Resource.prototype, {
  initialize : function(attributes) {
    ...
    for (var url in this.klass._urls){
		if(this.klass._urls.hasOwnProperty(url)){
  ...
  setAttributes : function(attributes)
  {
	...
	/*$H(attributes).each(
		bind(this, 
			function(attr){ this._setAttribute(attr.key, attr.value) }
		)
	);*/
    return attributes;
  },
